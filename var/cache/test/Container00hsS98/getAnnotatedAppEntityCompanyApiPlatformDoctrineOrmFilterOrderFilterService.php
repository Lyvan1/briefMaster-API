 ...
 */
class getAnnotatedAppEntityCompanyApiPlatformDoctrineOrmFilterOrderFilterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_company_api_platform_doctrine_orm_filter_order_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_company_api_platform_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), 'order', ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['name' => NULL, 'createdAt' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)), NULL);
    }
}
