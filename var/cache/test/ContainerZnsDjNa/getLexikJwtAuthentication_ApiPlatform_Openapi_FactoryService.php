...
class getLexikJwtAuthentication_ApiPlatform_Openapi_FactoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['lexik_jwt_authentication.api_platform.openapi.factory'] = new \Lexik\Bundle\JWTAuthenticationBundle\OpenApi\OpenApiFactory(($container->privates['App\\OpenApi\\OpenApiFactory'] ?? $container->load('getOpenApiFactoryService')), '/briefApi/login_check', 'email', 'password');
    }
}
