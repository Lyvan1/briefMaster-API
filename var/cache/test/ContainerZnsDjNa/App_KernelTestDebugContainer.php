...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BriefController' => 'getBriefControllerService',
            'App\\Controller\\CallMessageClearRefreshTokenController' => 'getCallMessageClearRefreshTokenControllerService',
            'App\\Controller\\Company\\PatchCompanyController' => 'getPatchCompanyControllerService',
            'App\\Controller\\DocusignController' => 'getDocusignControllerService',
            'App\\Controller\\LoggedUserController' => 'getLoggedUserControllerService',
            'App\\Controller\\PixelGeneratorController' => 'getPixelGeneratorControllerService',
            ...
            'App\\Controller\\User\\PatchUserController' => 'getPatchUserControllerService',
            'App\\Service\\TrackingPixelGenerator' => 'getTrackingPixelGeneratorService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.company_logo' => 'getSmartUniqueNamer_CompanyLogoService',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XkA438uQ+m', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventListener\\ValidationExceptionListener')] fn () => ($container->privates['App\\EventListener\\ValidationExceptionListener'] ??= new \App\EventListener\ValidationExceptionListener()), 'onKernelException'], 0);
     ...
     */
    protected static function getVichUploader_DownloadHandlerService($container)
    {
    ...
    /**
     * Gets the private 'App\Encoder\MultipartDecoder' shared autowired service.
     *
     * @return \App\Encoder\MultipartDecoder
     */
    protected static function getMultipartDecoderService($container)
    {
        return $container->privates['App\\Encoder\\MultipartDecoder'] = new \App\Encoder\MultipartDecoder(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
     ...
     */
    protected static function getCompanyRepositoryService($container)
    {
    ...
    /**
     * Gets the private 'App\Serializer\MediaObjectNormalizer' shared autowired service.
     *
     * @return \App\Serializer\MediaObjectNormalizer
     */
    protected static function getMediaObjectNormalizerService($container)
    {
        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container));

        if (isset($container->privates['App\\Serializer\\MediaObjectNormalizer'])) {
            return $container->privates['App\\Serializer\\MediaObjectNormalizer'];
        }

        return $container->privates['App\\Serializer\\MediaObjectNormalizer'] = new \App\Serializer\MediaObjectNormalizer(($container->privates['serializer.normalizer.object'] ?? self::getSerializer_Normalizer_ObjectService($container)), ($container->privates['vich_uploader.storage.file_system'] ?? self::getVichUploader_Storage_FileSystemService($container)), ($container->privates['App\\Repository\\CompanyRepository'] ?? self::getCompanyRepositoryService($container)), ($container->privates['App\\Repository\\UserRepository'] ?? self::getUserRepositoryService($container)), $a, ($container->services['vich_uploader.download_handler'] ?? self::getVichUploader_DownloadHandlerService($container)));
    }

    /**
     * Gets the private 'App\Serializer\UploadedFileDenormalizer' shared autowired service.
     *
     * @return \App\Serializer\UploadedFileDenormalizer
     */
    protected static function getUploadedFileDenormalizerService($container)
    {
        return $container->privates['App\\Serializer\\UploadedFileDenormalizer'] = new \App\Serializer\UploadedFileDenormalizer();
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pyELAJjOfF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bBd5FyYkq2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getApiPlatform_Metadata_Resource_MetadataCollectionFactory_LinkService($container)
    {
        ...
        return $container->privates['api_platform.metadata.resource.metadata_collection_factory.link'] = new \ApiPlatform\Metadata\Resource\Factory\LinkResourceMetadataCollectionFactory($a, ($container->privates['api_platform.metadata.resource.metadata_collection_factory.main_controller'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_MainControllerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.metadata.resource.metadata_collection_factory.main_controller'] = new \ApiPlatform\Metadata\Resource\Factory\MainControllerResourceMetadataCollectionFactory(($container->privates['api_platform.metadata.resource.metadata_collection_factory.uri_template'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_UriTemplateService($container)), false);
    }
    ...
    {
        return $container->privates['api_platform.metadata.resource.metadata_collection_factory.yaml'] = new \ApiPlatform\Metadata\Resource\Factory\ExtractorResourceMetadataCollectionFactory(($container->privates['api_platform.metadata.resource_extractor.yaml'] ??= new \ApiPlatform\Metadata\Extractor\YamlResourceExtractor([], $container)), ($container->privates['api_platform.metadata.resource.metadata_collection_factory.xml'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_XmlService($container)), $container->parameters['api_platform.defaults'], ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), false);
    }
     ...
     * @return \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer
     */
    protected static function getApiPlatform_Serializer_Normalizer_ValidationExceptionService($container)
    {
        return $container->privates['api_platform.serializer.normalizer.validation_exception'] = new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer(($container->privates['api_platform.serializer.normalizer.item'] ?? self::getApiPlatform_Serializer_Normalizer_ItemService($container)), ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z5OO4hgx07', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AbstractController', 'App\\Controller\\BriefController', 'App\\Controller\\CallMessageClearRefreshTokenController', 'App\\Controller\\Company\\PatchCompanyController', 'App\\Controller\\DocusignController', 'App\\Controller\\LoggedUserController', 'App\\Controller\\PixelGeneratorController', 'App\\Controller\\SecurityController', 'App\\Controller\\TestMailController', 'App\\Controller\\User\\PatchUserController', 'App\\Service\\TrackingPixelGenerator', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.company_logo'], [['preUpdate'], 'vich_uploader.listener.clean.user_avatar'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.company_logo'], [['postFlush'], 'vich_uploader.listener.remove.company_logo'], [['prePersist'], 'vich_uploader.listener.upload.company_logo'], [['preUpdate'], 'vich_uploader.listener.upload.company_logo'], [['preRemove'], 'vich_uploader.listener.remove.user_avatar'], [['postFlush'], 'vich_uploader.listener.remove.user_avatar'], [['prePersist'], 'vich_uploader.listener.upload.user_avatar'], [['preUpdate'], 'vich_uploader.listener.upload.user_avatar']]);
    }
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.login' => ($container->privates['.security.request_matcher.1g.eJdh'] ?? $container->load('get_Security_RequestMatcher_1g_EJdhService'));
            yield 'security.firewall.map.context.api' => ($container->privates['.security.request_matcher.IggHjzP'] ?? $container->load('get_Security_RequestMatcher_IggHjzPService'));
    ...
    {
        $a = ($container->privates['App\\Serializer\\MediaObjectNormalizer'] ?? self::getMediaObjectNormalizerService($container));
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([($container->privates['serializer.denormalizer.unwrapping'] ?? self::getSerializer_Denormalizer_UnwrappingService($container)), $a, ($container->privates['App\\Serializer\\UploadedFileDenormalizer'] ??= new \App\Serializer\UploadedFileDenormalizer()), $c, $c, ($container->privates['api_platform.normalizer.constraint_violation_list'] ?? self::getApiPlatform_Normalizer_ConstraintViolationListService($container)), ($container->privates['api_platform.hydra.normalizer.constraint_violation_list'] ?? self::getApiPlatform_Hydra_Normalizer_ConstraintViolationListService($container)), ($container->privates['api_platform.problem.normalizer.constraint_violation_list'] ?? self::getApiPlatform_Problem_Normalizer_ConstraintViolationListService($container)), $c, $b, ($container->privates['api_platform.hydra.normalizer.documentation'] ?? self::getApiPlatform_Hydra_Normalizer_DocumentationService($container)), ($container->privates['api_platform.hydra.normalizer.entrypoint'] ?? self::getApiPlatform_Hydra_Normalizer_EntrypointService($container)), ($container->privates['api_platform.hydra.normalizer.error'] ?? self::getApiPlatform_Hydra_Normalizer_ErrorService($container)), ($container->privates['api_platform.serializer.normalizer.validation_exception'] ?? self::getApiPlatform_Serializer_Normalizer_ValidationExceptionService($container)), ($container->privates['api_platform.problem.normalizer.error'] ??= new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, [])), ($container->privates['serializer.normalizer.flatten_exception'] ??= new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer()), ($container->privates['serializer.normalizer.problem'] ??= new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL)), ($container->privates['serializer.normalizer.uid'] ??= new \Symfony\Component\Serializer\Normalizer\UidNormalizer()), ($container->privates['api_platform.jsonld.normalizer.item'] ?? self::getApiPlatform_Jsonld_Normalizer_ItemService($container)), ($container->privates['api_platform.serializer.normalizer.item'] ?? self::getApiPlatform_Serializer_Normalizer_ItemService($container)), ($container->privates['serializer.normalizer.datetime'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer()), ($container->privates['serializer.normalizer.constraint_violation_list'] ?? self::getSerializer_Normalizer_ConstraintViolationListService($container)), ($container->privates['serializer.normalizer.mime_message'] ?? self::getSerializer_Normalizer_MimeMessageService($container)), ($container->privates['serializer.normalizer.datetimezone'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer()), ($container->privates['serializer.normalizer.dateinterval'] ??= new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer()), ($container->privates['serializer.normalizer.form_error'] ??= new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer()), ($container->privates['serializer.normalizer.backed_enum'] ??= new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer()), ($container->privates['serializer.normalizer.data_uri'] ?? self::getSerializer_Normalizer_DataUriService($container)), ($container->privates['serializer.normalizer.json_serializable'] ??= new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL)), ($container->privates['api_platform.hydra.normalizer.collection_filters'] ?? self::getApiPlatform_Hydra_Normalizer_CollectionFiltersService($container)), ($container->privates['serializer.denormalizer.array'] ??= new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer()), ($container->privates['api_platform.jsonld.normalizer.object'] ?? self::getApiPlatform_Jsonld_Normalizer_ObjectService($container)), ($container->privates['serializer.normalizer.object'] ?? self::getSerializer_Normalizer_ObjectService($container))], [($container->privates['App\\Encoder\\MultipartDecoder'] ?? self::getMultipartDecoderService($container)), ($container->privates['serializer.encoder.xml'] ??= new \Symfony\Component\Serializer\Encoder\XmlEncoder()), ($container->privates['serializer.encoder.json'] ??= new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL)), ($container->privates['serializer.encoder.yaml'] ??= new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL)), ($container->privates['serializer.encoder.csv'] ??= new \Symfony\Component\Serializer\Encoder\CsvEncoder()), ($container->privates['api_platform.jsonopenapi.encoder'] ??= new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL)), ($container->privates['api_platform.yamlopenapi.encoder'] ?? self::getApiPlatform_Yamlopenapi_EncoderService($container)), ($container->privates['api_platform.jsonld.encoder'] ??= new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL)), ($container->privates['api_platform.problem.encoder'] ??= new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'))]);
    }
    ...
    {
        return $container->privates['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory(($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), ($container->privates['vich_uploader.property_mapping_resolver'] ?? self::getVichUploader_PropertyMappingResolverService($container)));
    }
     ...
     */
    protected static function getVichUploader_PropertyMappingResolverService($container)
    {
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'logos_directory' => (\dirname(__DIR__, 4).'/public'),
            ...
            'api_platform.collection.pagination.items_per_page' => 15,
            ...
            'vich_uploader.mappings' => [
                'company_logo' => [
                    'uri_prefix' => '/images/company_logos',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/company_logos'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.company_logo',
                        'options' => [
                ...
                'user_avatar' => [
                    'uri_prefix' => '/images/user_avatar',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/user_avatar'),
                    'namer' => [
