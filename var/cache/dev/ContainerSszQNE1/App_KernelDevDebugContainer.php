...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dKNMSjxnRo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\BriefSelectionRepository' => ['privates', 'App\\Repository\\BriefSelectionRepository', 'getBriefSelectionRepositoryService', true],
            ...
            'App\\Repository\\CompanyRoleRepository' => ['privates', 'App\\Repository\\CompanyRoleRepository', 'getCompanyRoleRepositoryService', true],
            ...
            'App\\Repository\\RolesCompanyRepository' => ['privates', 'App\\Repository\\RolesCompanyRepository', 'getRolesCompanyRepositoryService', true],
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AbstractController', 'App\\Controller\\BriefController', 'App\\Controller\\CallMessageClearRefreshTokenController', 'App\\Controller\\Company\\PatchCompanyController', 'App\\Controller\\DocusignController', 'App\\Controller\\LoggedUserController', 'App\\Controller\\PixelGeneratorController', 'App\\Controller\\SecurityController', 'App\\Controller\\TestMailController', 'App\\Controller\\User\\PatchUserController', 'App\\Service\\TrackingPixelGenerator', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tMRFf4lgHU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ux9xSluCvu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('66rxgYtEHj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $d = ($container->privates['api_platform.serializer.mapping.class_metadata_factory'] ?? self::getApiPlatform_Serializer_Mapping_ClassMetadataFactoryService($container));
        ...
        $h = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($d, $e, $c, $f, $g, NULL);
        $i = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL);

        $j = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $c, $f)], [$i]))));
        ...
        $o = ($container->privates['api_platform.symfony.iri_converter'] ?? self::getApiPlatform_Symfony_IriConverterService($container));
        $p = ($container->privates['api_platform.resource_class_resolver'] ?? self::getApiPlatform_ResourceClassResolverService($container));
        $q = ($container->privates['api_platform.jsonld.context_builder'] ?? self::getApiPlatform_Jsonld_ContextBuilderService($container));

        $r = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($l, $m, $n, $o, $p, $q, $c, $e, $d, [], $b);
        $s = new \ApiPlatform\Serializer\ItemNormalizer($m, $n, $o, $p, $c, $e, $d, NULL, $l, $b);
        $t = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($c), new \App\Serializer\MediaObjectNormalizer($h, ($container->privates['vich_uploader.storage.file_system'] ?? self::getVichUploader_Storage_FileSystemService($container)), ($container->privates['App\\Repository\\CompanyRepository'] ?? self::getCompanyRepositoryService($container)), ($container->privates['App\\Repository\\UserRepository'] ?? self::getUserRepositoryService($container)), $a, ($container->services['vich_uploader.download_handler'] ?? self::getVichUploader_DownloadHandlerService($container))), new \App\Serializer\UploadedFileDenormalizer(), $j, $j, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $e), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $e), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $e), $j, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $e), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($l, $m, $n, $p, $k, $e), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($l, $o, $k), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, true, []), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($s, $e), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $r, $s, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($d, $e, $f, $g, NULL)), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($q, $p, $o, NULL), 'page', 'pagination', $l, $c), $l, $p, ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container))), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($h, $o, $q), $h], [new \App\Encoder\MultipartDecoder(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $i, $t, new \Symfony\Component\Serializer\Encoder\CsvEncoder(), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $t), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
