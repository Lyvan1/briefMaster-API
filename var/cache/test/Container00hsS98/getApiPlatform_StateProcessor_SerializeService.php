...
class getApiPlatform_StateProcessor_SerializeService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.state_processor.serialize'] = new \ApiPlatform\State\Processor\SerializeProcessor(($container->privates['api_platform.hydra.processor.link'] ?? $container->load('getApiPlatform_Hydra_Processor_LinkService')), ($container->privates['serializer'] ?? self::getSerializerService($container)), ($container->privates['api_platform.serializer.context_builder.filter'] ?? self::getApiPlatform_Serializer_ContextBuilder_FilterService($container)));
    }
}
